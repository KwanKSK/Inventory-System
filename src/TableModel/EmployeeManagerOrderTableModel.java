 ...
 * @author User
 */
public class EmployeeManagerOrderTableModel extends AbstractTableModel {
    // For switch function
    public static final int OBJECT_COL = -1;
    private static final int ID_COL = 0;
    private static final int PRODUCT_NAME_COL = 1;
    private static final int AMOUNT_BOX_COL = 2;
    private static final int ORDER_DATE_COL = 3;
    private static final int RECEIVED_DATE_COL = 4;
    private static final int STATUS_COL = 5;
    
    // Name of each attribute
    private String[] columnNames = {"Order ID", "Product Name", "Amount (Box)", "Order Date", "Received Date", "Status"};
    private List<Orders> orders;    // Store data of this table
    
    // Get the data for this table
    public EmployeeManagerOrderTableModel(List<Orders> orders)
    {
        this.orders = orders;
    }
    ...
    public Object getValueAt(int row, int col)
    {
        ...
        switch(col) {
            ...
            case RECEIVED_DATE_COL:         // Get receive date
                return tempOrders.getReceivedDate();
